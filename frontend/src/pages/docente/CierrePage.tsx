...
export default function CierrePage() {
  ...
  const handleCerrar = async () => {
    ...
    try {
      ...
      alert('Sección cerrada. Las notas son definitivas.')
      navigate('/docente')
    } catch (err: any) {
      ...
      <div className="w-full max-w-md rounded-xl bg-white p-8 shadow-lg text-center">
        ...
        <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-left mb-6">
          ...
          <ul className="mt-2 space-y-1 text-sm text-amber-700">
            ...
            <li>• Esta acción requiere rectificación para cambios posteriores</li>
          </ul>
        </div>
        ...
        <div className="flex gap-4">
          ...
          <button onClick={handleCerrar} disabled={loading}
            className="flex-1 rounded-lg bg-red-600 px-4 py-3 text-white hover:bg-red-700 disabled:opacity-50">
